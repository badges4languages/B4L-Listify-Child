...
<!-- MLS CODE -->
			...
			<!-- 	The code to show thow the custom fields for the author page
				    It displays the following information for the author:	       -->
			<div class="author-body" style="clear:left; float:left; margin-right:20%; min-height: 60%;">
					</br>
					<ul  style="list-style: none;">
							<!-- Display name -->
							<li style="float:left; font-size:50%"><span class="dashicons dashicons-admin-users"></span> <?php the_author_meta( 'display_name' ); ?></br></li>
							<!-- Date of membership -->
							...
							<!-- Email Address -->
							<li style="clear:left; float:left; font-size:50%"><span class="dashicons dashicons-format-chat"></span> <?php the_author_meta( 'user_email' ); ?> </br></li>
							<!-- Mother tongue -->
							<li style="clear:left; float:left; font-size:50%"><span class="dashicons dashicons-format-chat"></span><?php the_author_meta( 'rcp_mother_tongue' ); ?> </br></li>
							<!-- University -->
							<li style="clear:left; float:left; font-size:50%"><span class="dashicons dashicons-format-chat"></span> <?php the_author_meta( 'rcp_university'); ?> </br></li>
							<!-- Other Education -->
							<li style="clear:left; float:left; font-size:50%"><span class="dashicons dashicons-format-chat"></span> <?php the_author_meta('rcp_other_education'); ?> </br></li>
							<!-- Profession -->
							<li style="clear:left; float:left; font-size:50%"><span class="dashicons dashicons-format-chat"></span> <?php the_author_meta( 'rcp_profession'); ?> </br></li>
							<!-- Location -->
							<li style="clear:left; float:left; font-size:50%"><span class="dashicons dashicons-format-chat"></span> <?php the_author_meta( 'rcp_location'); ?> </br></li>
							<!-- The URL -->
							<li style="clear:left; float:left; font-size:50%"><span class="dashicons dashicons-admin-links"></span> <a href="<?php the_author_meta( 'user_url' ); ?>">My personnal website</a> </br></li>
					</br>
					</ul>
...
<?php  //function current_user_badges( $user ) {
			  ...
			  $currentbadges = get_the_author_meta( 'user_badges', $current_user->ID );
				...
				?>
				<!-- To show the default image if there is no badge -->
					...
					foreach ($currentbadges as $currentbadge):
						foreach ($allbadges as $badge):
								 if ($currentbadge['name']==$badge->post_title):
									 ?>
									 <!-- Showing all the badges earned by the student -->
