...
function my_custom_menu_item($items)
{
    if( is_user_logged_in() ) {
        ...
        $items .= 
        '<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-87"><a href="'. home_url() . '/author/' . $user->user_login . '"><img id="menu-avatar" class="circle-img" src="' . $urlAvatar . '" height="40" width="40">' . $name . '</a>
          <ul class="sub-menu">
            <li class="ion-person menu-item menu-item-type-post_type menu-item-object-page"><a href="'. home_url() . '/author/' . $user->user_login . '">Profile</a></li>';
